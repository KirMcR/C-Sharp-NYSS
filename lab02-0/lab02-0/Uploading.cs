    ...
    class Uploading
    {
        ...
        public Uploading()
        {
            ...
            try
            {
                ...
                Thread.Sleep(3000);
                metrics = Pars.EnumerateMetrics(Dir).ToList();
            }
            catch { MessageBox.Show("При загрузке произошла ошибка. Проверьте свое соединение либо ссылку на файл.", "Ошибка", MessageBoxButton.OK, MessageBoxImage.Error); }
        }
    }
}
